"""
Django settings for extraccion_datos project.
...
SECRET_KEY = 'django-insecure-#b$6!mt(12j^tb^v89^0e+*cx9@4l1bspwg=fv*wx1y7)x_r#='
...
ROOT_URLCONF = 'extraccion_datos.urls'
...
WSGI_APPLICATION = 'extraccion_datos.wsgi.application'
